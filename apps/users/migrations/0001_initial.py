    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('carrier', 'Курьер'), ('client', 'Клиент')], default='client', max_length=16)),
                ...
                ('phone_number', models.CharField(max_length=13, unique=True, validators=[django.core.validators.RegexValidator('^(?:\\+996\\d{9})$', 'Формат телефона: +996XXXXXXXXX (Кыргызстан).')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_front', models.ImageField(blank=True, null=True, upload_to=apps.users.models.kyc_upload_to)),
                ('id_back', models.ImageField(blank=True, null=True, upload_to=apps.users.models.kyc_upload_to)),
